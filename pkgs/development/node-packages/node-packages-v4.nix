...
let
  sources = {
    ...
    "express-4.16.1" = {
      ...
      version = "4.16.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/express/-/express-4.16.1.tgz";
        sha512 = "03hr8b3xb1195kxh6zx217lq3n9780mic8dfmw555q9h5vg54mq89rrglca39638rss6g9q74fi9fm1nrb1lisjsjybzl0dkqnpnc29";
      };
    };
    "rc-1.2.1" = {
      name = "rc";
