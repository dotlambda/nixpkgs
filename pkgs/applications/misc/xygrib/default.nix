{ lib, stdenv, fetchFromGitHub, wrapQtAppsHook, cmake, bzip2, qtbase, qttools, libnova, proj7, libpng, openjpeg }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ bzip2 qtbase libnova proj7 openjpeg libpng ];
